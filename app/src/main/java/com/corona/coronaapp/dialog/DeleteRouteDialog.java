...
public class DeleteRouteDialog {
    ...
    public void callDialog() {
        ...
        TextView route_position_text = (TextView)delete_route_dialog.findViewById(R.id.sub2_text);
        Spinner spinner = (Spinner)delete_route_dialog.findViewById(R.id.dialog_spinner);
